...
<body class="bg-slate-50">
    ...
    <div class="header px-4 py-8 md:px-6 md:py-12 text-center relative">
        <div class="max-w-7xl mx-auto">
            ...
            <!-- Legend Section with Updated Time Slots -->
...
ALTER TABLE presensi_records DISABLE ROW LEVEL SECURITY;</pre>
    ...
    <script>
        ...
        // Menyiar status ketukan layar aktif hari ini ke database agar pemantau lain tersinkronisasi
        async function broadcastActiveSelections() {
            ...
            try {
                ...
                setTimeout(() => {
                    if (syncDot && syncText) {
                        syncDot.className = "relative inline-flex rounded-full h-2 w-2 bg-emerald-500";
                        syncText.innerText = "Monitoring Tangguh (Real-time)";
                    }
                }, 800);
            }
        }
        ...
        // --- STREAMING_CHUNK: Menyediakan fungsi backup lokal dan manipulasi list siswa... ---
        ...
        // --- STREAMING_CHUNK: Menerapkan aturan logika waktu presensi terbaru SMP Hamalatul Quran... ---
        // --- AKSI KETUKAN DAN TOMBOL PRESENSI ---

        // Sentuh area baris nama siswa mana saja untuk mendaftarkan kehadiran berdasarkan waktu sistem saat ini
        function toggleAbsen(id, kls, nama) {
            ...
            // Menghitung jumlah menit sejak tengah malam agar pengelompokan waktu presensi berjalan dengan akurat
        ...
        // --- STREAMING_CHUNK: Memproses fungsi ekspor dan dokumen PDF harian/berkala... ---
